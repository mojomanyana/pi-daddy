...
**Release-preparation evidence (2026-09-12): 0.25.0 candidate; the registry-verified baseline at that
measurement was 0.24.0.** For current publication status consult npm and GitHub Releases. The candidate adds
practical daily steering/rebind, explicit closing review, opt-in measured sessions and bounded dependent orders while keeping governance ledger v3
...
packages/pi-daddy  — THE PRODUCT (0.25.0 source; current publication status is on npm/GitHub Releases): Agent Skill
