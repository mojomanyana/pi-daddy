...
**Current state: `pi-agent-grants` 0.12.1 — the only package.** Twenty-five ADRs decided. 292 unit +
21 integration tests (+4 more with a real model), typecheck and smoke clean.
