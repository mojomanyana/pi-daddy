...
ledger version and versioned artifact path. The already-published npm 0.18.0 does not contain these files;
...
```bash
npm test                   # 591 unit tests. Fast, pure, no pi, no network.
