...
import { createWorkPolicyRegistry, openWorkPolicyRegistry, policyForSetup, workPolicyDigest, workPolicyActivationDigest, type WorkPolicyActivation } from "../src/products/work-policy-registry.ts";
...
import { buildAdoptionBinding, authorizeAdoption, buildRollbackRequest, type RollbackRequest } from "../src/products/vendor/adoption.ts";
