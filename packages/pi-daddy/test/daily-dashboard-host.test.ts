...
test("supported daily host command composition publishes fresh work and pauses only new ordinary dispatch", async () => {
  ...
  const harness=adoptDashboardHarnessBridge({version:"skill-harness-dashboard-bridge-v1",sourceCommit:"73ab11883bb1c8924dc5ebbe8a61c96e913ee437",api:loaded.api});
