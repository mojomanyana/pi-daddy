...
import { learningHarness, bindLearningConnection, loadLearningConnection, learningScopeDigest, type LearningUI } from "../src/learning-connection.ts";
import { loadDeclaredWork } from "../src/work-command.ts";
import { privateDirectory } from "../src/product-files.ts";
