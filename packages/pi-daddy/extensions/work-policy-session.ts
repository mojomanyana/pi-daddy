...
import { createWorkPolicyRegistry, openWorkPolicyRegistry, policyForSetup, workPolicy, workPolicyDigest, workPolicyActivationDigest, type WorkPolicy, type WorkPolicyRegistry, type WorkPolicyActivation } from "../src/work-policy-registry.ts";
import { loadWorkSetup, type WorkSetup } from "../src/work-setup.ts";
import { bindLearningAdoption, learningScopeDigest, type LearningHarness, type LearningWorkspace } from "../src/learning-connection.ts";
import type { DeclaredWorkState } from "../src/work-command.ts";
import { privateDirectory, readProductJson, writeProductJson } from "../src/product-files.ts";
import type { AdoptionBinding, AdoptionFacts } from "../src/vendor/adoption.ts";
