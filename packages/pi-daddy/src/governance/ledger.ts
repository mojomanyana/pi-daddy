...
import type { ApprovalScope, ApprovalSource } from "../kernel/approval.ts";
...
// R-49: the lock moved to `src/governance/file-lock.ts` so the approvals store could use the SAME one rather than
