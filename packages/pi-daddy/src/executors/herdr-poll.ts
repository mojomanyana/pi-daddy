 ...
 *
 * Split out of `src/executors/run-herdr.ts` when that file hit **404 of the 400-line ceiling** adding ADR-0032's output
...
import { herdrSessionReference } from "../governance/native-session.ts";
