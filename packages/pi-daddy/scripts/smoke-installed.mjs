...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      `import v3ReceiptFixture from "pi-daddy/contracts/ledger-record/v1/fixtures/check-receipt.json" with { type: "json" };`,
      `import v3WorkflowFixture from "pi-daddy/contracts/ledger-record/v1/fixtures/workflow-fact.json" with { type: "json" };`,
