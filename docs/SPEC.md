...
the learning and debrief flow (`/grants learning`, requires `skill-harness`), the activity timeline, and the
opt-in measured, factory and producer-IPC paths are described for users in
