# pi-daddy changelog, versions before 0.13.0 (archived 2026-09-21)

None of these versions was published to npm; 0.13.0 was the first. Moved verbatim from `packages/pi-daddy/CHANGELOG.md`
by the cleanup PR, kept because the reasoning behind each is often the clearest statement of why the current behaviour
is what it is.
